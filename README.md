...
- 提醒：计划可设置未打卡提醒时间；今日页右上角统一进入消息中心，红点区分未读，仅保留最近 20 条；支持一次性微信订阅消息。
...
- 群组：支持个人群聊备注与置顶、复制群组 ID、邀请、计划群组绑定和逐项打卡动态；成员按未完成比例排序，可查看仅含群组任务进度的当月打卡日历；绑定计划的修改、停用、删除和解绑需经相关群主审核。
