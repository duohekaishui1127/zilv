...
- 计划：每天、工作日、周末、指定星期、每周 N 次；支持正计时、倒计时、暂停恢复、跨天继续计时及自动打卡。五个底部导航页顶部显示当前计时，点击可返回“今日”定位任务。
- 提醒：计划可设置未打卡提醒时间；今日页右上角统一进入消息中心，红点区分未读，仅保留最近 20 条；支持一次性与长期微信订阅消息，长期模板授权一次后可在后续应打卡日持续提醒。
- 趋势与复盘：支持 7/30/90 天身体、能量、运动和学习趋势。
- 自律日历：默认首页以整日打卡心情标记日期，绿色表示任务全部完成，红色表示打卡时任务尚未完成；原页查看当天小记和默认收起的完整任务进度，不跳转详情页面。
- 今日：计划支持连续快速完成、独立同步和 5 秒撤销，微信提醒续订不会阻断打卡；进度满后自动打卡，任务未完成时也可点击“打卡”记录特殊情况。
