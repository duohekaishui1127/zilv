...
5. 调用 `admin-init` 一次，确认 `success: true`、`appVersion: 1.2.0`、`schemaVersion: 4`。
...
12. 编译运行并在“我的 → 关于与诊断”确认客户端/服务端版本均为 1.2.0、Schema 均为 4。
13. 真机测试趋势图、月份切换、订阅授权、未打卡提醒、消息中心、拍照和日志功能。
